...
game:GetService('RunService').RenderStepped:Connect(function()
		local sdg = math.floor(game:GetService('Stats').Network.ServerStatsItem["Data Ping"]:GetValue())
	end)
...
library.theme = {
    ...
    accentcolor = Color3.fromRGB(30, 30, 27),
    accentcolor2 = Color3.fromRGB(30, 30, 27),
    outlinecolor = Color3.fromRGB(160, 76, 213),
    outlinecolor2 = Color3.fromRGB(23, 24, 23),
